...
const chipPutSound = new Audio("sounds/roullete/chip-put.mp3");
const selectSound = new Audio("sounds/roullete/chip-select.mp3");
const menuSound = new Audio("sounds/roullete/menu.mp3");
const ballSpinSound = new Audio("sounds/roullete/ball-spin.mp3");
const winSound = new Audio("sounds/roullete/win.mp3");
const winChipsSound = new Audio("sounds/roullete/win-chips.mp3");
const ambientSound = new Audio("sounds/roullete/ambient-sounds.mp3");
const backgroundMusic = new Audio("sounds/roullete/background-music.mp3");
